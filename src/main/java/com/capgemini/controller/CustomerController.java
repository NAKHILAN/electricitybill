...
public class CustomerController {
	...
	public ResponseEntity<Customer> searchCustomerByAadhaar(@Valid @PathVariable String aadhaar) throws NoSuchCustomerException {
	...
	public ResponseEntity<Customer> searchCustomerByCustomerId(@PathVariable @Valid String customerId)
			throws NoSuchCustomerException {
